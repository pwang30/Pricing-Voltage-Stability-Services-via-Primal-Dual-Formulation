...
# MPEC of markets for voltage stability services
# 10.Dec.2025
...
include("VSS_MPEC_Service_Offers.jl")
include("MPEC_VS_LL.jl")
...
Oᵐ=[10.47, 11.47, 12.47, 13.47, 14.47, 15.47]                   #  Marginal generation cost of SGs   in    SGs, buses:2,3,4,5,27,30
Oⁿˡ=Oᵐ*10 


#------------------------------------------------------------------------------
#--------Obtain honest offers of ancillary services------------------------
#------------------------------------------------------------------------------

c_SS_bus_23, c_SS_bus_24, c_AP_bus_23, c_AP_bus_24, c_RP_bus_23, c_RP_bus_24 = service_offer(
    K_c_gc, K_c_gv, K_c_m, sh_1, sh_2, bus_num, T, Pᴰ, Qᴰ, bus_connection, S_lines, 
                       Pˢᴳₘₐₓ, Pˢᴳₘᵢₙ, Qˢᴳₘₐₓ, Qˢᴳₘᵢₙ, 
                       Pⱽˢᴳₘₐₓ, Pⱽˢᴳₘᵢₙ, Qⱽˢᴳₘₐₓ, Qⱽˢᴳₘᵢₙ,
                       Pᴵᴮᴳₘₐₓ, Pᴵᴮᴳₘᵢₙ, Qᴵᴮᴳₘₐₓ, Qᴵᴮᴳₘᵢₙ,
                       Sᵐᵃˣ_gc, Sᵐᵃˣ_gv, Sᵐᵃˣ_c,
                       α_VSG, α_IBG, ratio, S_base,
                       Kˢᵗ, Kˢʰ, Oᵐ, Oⁿˡ)

c_SS_bus_23 = ones(T) * sum(c_SS_bus_23) / T
c_SS_bus_24 = ones(T) * sum(c_SS_bus_24) / T
c_AP_bus_23 = ones(T) * sum(c_AP_bus_23) / T
c_AP_bus_24 = ones(T) * sum(c_AP_bus_24) / T
c_RP_bus_23 = ones(T) * sum(c_RP_bus_23) / T
c_RP_bus_24 = ones(T) * sum(c_RP_bus_24) / T
...
bid_energy_SG_27 = 1
bid_energy_SG_30 = 1
bid_SS_SG_2_bus_23 = 1
bid_SS_SG_3_bus_23 = 1
bid_SS_SG_4_bus_23 = 1
bid_SS_SG_5_bus_23 = 1
bid_SS_SG_27_bus_23 = 1
bid_SS_SG_30_bus_23 = 1
bid_SS_SG_2_bus_24 = 1  
bid_SS_SG_3_bus_24 = 1
bid_SS_SG_4_bus_24 = 1
bid_SS_SG_5_bus_24 = 1
bid_SS_SG_27_bus_24 = 1
bid_SS_SG_30_bus_24 = 1
bid_SS_VSG_bus_23 = 1
bid_SS_VSG_bus_24 = 1
bid_AP_IBG_23_bus_23 = 1
bid_AP_IBG_23_bus_24 = 1
bid_AP_IBG_24_bus_24 = 1
bid_AP_IBG_24_bus_23 = 1
bid_RP_IBG_23_bus_23 = 1
bid_RP_IBG_23_bus_24 = 1
bid_RP_IBG_24_bus_24 = 1
bid_RP_IBG_24_bus_23 = 1

DG, energy_prices_P, price_AP_bus_23, price_AP_bus_24, price_Γ_bus_23, price_Γ_bus_24, price_RP_bus_23, price_RP_bus_24 = MPEC_VS_LL(K_c_gc, K_c_gv, K_c_m, sh_1, sh_2, bus_num, T, Pᴰ, Qᴰ, bus_connection, S_lines, 
                       Pˢᴳₘₐₓ, Pˢᴳₘᵢₙ, Qˢᴳₘₐₓ, Qˢᴳₘᵢₙ, 
                       Pⱽˢᴳₘₐₓ, Pⱽˢᴳₘᵢₙ, Qⱽˢᴳₘₐₓ, Qⱽˢᴳₘᵢₙ,
                       Pᴵᴮᴳₘₐₓ, Pᴵᴮᴳₘᵢₙ, Qᴵᴮᴳₘₐₓ, Qᴵᴮᴳₘᵢₙ,
                       Sᵐᵃˣ_gc, Sᵐᵃˣ_gv, Sᵐᵃˣ_c,
...
plot(energy_prices_P')

plot(price_AP_bus_23)
plot!(price_RP_bus_23)
plot!(price_Γ_bus_23)
