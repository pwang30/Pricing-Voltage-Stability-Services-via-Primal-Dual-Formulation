...
#------------Evaluate the impedance in all Ω scenarios
    ...
    zᵟ_c=zeros(Ω,(num_IBG*(num_IBG-1)+num_IBG))                 # Impedance ratio in all Ω scenarios, for each row, the zᵟ_c is   [z₂₃²⁴, z₂₄²³, z₂₃¹, z₂₄¹]
    ...
    for k in 1:Ω
        ...
        status_VSG = matrix_ω[k, 13]   # status of VSG
        ...
        zᵟ_c[k,1] =   Z[IBG[1],IBG[2]] /Z[IBG[1],IBG[1]]  # calculate the impedance ratio, [z₂₃²⁴, z₂₄²³, z₂₃¹, z₂₄¹]
        zᵟ_c[k,2] =   Z[IBG[2],IBG[1]]  /Z[IBG[2],IBG[2]] 
        zᵟ_c[k,3] = 1/Z[IBG[1],IBG[1]] 
        zᵟ_c[k,4] = 1/Z[IBG[2],IBG[2]] 
    end
